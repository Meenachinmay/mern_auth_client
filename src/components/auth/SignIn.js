    ...
    return (
        <div className="flex-col container mx-auto text-center p-3 m-3">
            ...
            <form>
                ...
                <div>
                    <button className="bg-green-300 text-white uppercase hover:bg-green-500 w-1/2 text-center font-semibold rounded px-3 py-4 focus:outline-none" type="password">Sign In</button>
                </div>
            </form>
        </div>
    )
